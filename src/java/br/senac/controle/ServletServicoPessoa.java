...
import br.senac.entidade.MainLeitura;
...
public class ServletServicoPessoa extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
         ...
         //   String banco = this.getServletConfig().getServletContext().getInitParameter("banco");
         //   String versao = this.getServletConfig().getServletContext().getInitParameter("banco_versao");
